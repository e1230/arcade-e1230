...
// Íconos pixel de 16x16 dibujados con rects, heredan el color de la tarjeta (referencia: about.jsx líneas 121-155)
export function HighlightIcon({ kind }: HighlightIconProps) {
  const C = "currentColor";
  if (kind === "HEART") {
    return (
      <svg className="h-9 w-9 [filter:drop-shadow(0_0_6px_currentColor)] [image-rendering:pixelated]" viewBox="0 0 16 16">
        <g fill={C}>
