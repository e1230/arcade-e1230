...
// Íconos pixel de 16x16 dibujados con rects, heredan el color de la tarjeta (referencia: home.jsx líneas 297-336)
export function FeatureIcon({ kind }: FeatureIconProps) {
  const C = "currentColor";
  if (kind === "GAMEPAD") {
    return (
      <svg className="h-11 w-11 [filter:drop-shadow(0_0_8px_currentColor)] [image-rendering:pixelated]" viewBox="0 0 16 16">
        <g fill={C}>
